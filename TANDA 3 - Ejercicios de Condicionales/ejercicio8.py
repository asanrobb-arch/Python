...
if puntuacion == 0.0:
    print ("Nivel de rendimiento inaceptable, no recibe dinero.")
elif puntuacion == 0.4:
    print (f"Nivel de rendimiento aceptable, recibe {2400*puntuacion} €.")
elif puntuacion >= 0.6:
    print (f"Nivel de rendimiento meritorio, recibe {2400*puntuacion} €.")