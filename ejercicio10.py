...
Payasos = input("Introduzca el número de payasos vendidos: ")
Muñecas = input("Introduzca el número de muñecas vendidas: ")

Peso = float(Payasos)*112 + float(Muñecas)*75

print(f"El peso total del paquete que será enviado es de {Peso} g.")