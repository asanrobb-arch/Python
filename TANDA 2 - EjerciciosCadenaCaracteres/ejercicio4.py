...
telefono = str(input("Introduzca su teléfono incluyendo prefijo y extensión: "))

print (f"El teléfono sin el prefijo: {telefono[0:4]} y la extensión: {telefono[13:16]} es = {telefono[4:13]}")